...
export default function App() {
    ...
    return (
        <ImageBackground source={(typeof weatherData.main != 'undefined') ? (weatherData.main.temp > 50) ? require('./assets/warm-bg.jpg') : require('./assets/cold-bg.jpg') : require('./assets/cold-bg.jpg')} style={{ width: '100%', height: '110%'}}>
            <ScrollView>
